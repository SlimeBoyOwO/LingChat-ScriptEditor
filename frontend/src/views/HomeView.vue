      ...
      <h1 class="text-5xl font-extrabold mb-8 tracking-wide relative">
        ...
        >
          ...
          <div class="flex items-center justify-between text-xs text-gray-500 mt-auto">
            <span class="bg-gray-900 px-2 py-1 rounded border border-gray-700">起始章节: {{ script.intro_chapter }}</span>
            <span v-if="script.script_settings?.user_name">作者: {{ script.script_settings.user_name }}</span>
          </div>
        </div>
